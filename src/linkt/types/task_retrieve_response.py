...
__all__ = ["TaskRetrieveResponse", "TaskConfig", "TaskConfigOnDemandIngestTaskConfigResponse"]


class TaskConfigOnDemandIngestTaskConfigResponse(BaseModel):
...
TaskConfig: TypeAlias = Annotated[
    Union[
        ...
        TaskConfigOnDemandIngestTaskConfigResponse,
